...
const slice = createSlice({
  ...
  selectors: {
    ...
    selectFilterTask:(state,todolistId:string,filter:FilterValuesType)=>{
...
const addTask = createAppAsyncThunk<{ task: TaskType }, AddTaskArgType>(`${slice.name}/addTask`, async (arg, { rejectWithValue }) => {
...
export const { selectTasks ,selectFilterTask} = slice.selectors
